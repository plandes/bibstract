...
\usepackage{someproj}
%\usepackage[usesidenotes]{someproj}
\usepackage{zenmath}
...
\zzaddbiblatexstyle[numeric]{someproj.bib}
...
\authorcite{biswasGraphBasedKeyword2018}.
...
% this needs \makeindex in the preamble (someproj.sty) and tex-index in makefile
%\printindex
